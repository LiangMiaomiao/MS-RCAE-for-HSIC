...
for i=1:n
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if net.layers{i}.precious==true
        multiscale_feature_FCN=res(i+1).x;
        save(sprintf('data/features/multiscale_FCNspatial/%s_scale%d.mat',net.featureName,i), 'multiscale_feature_FCN');
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
